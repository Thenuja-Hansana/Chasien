const ICONS = {
  ...
  apple: [{ t: 'path', d: 'M16.4 12.8c0-2.6 2.1-3.8 2.2-3.9-1.2-1.7-3-2-3.7-2-1.6-.2-3 .9-3.8.9s-2-.9-3.3-.9c-1.7 0-3.3 1-4.1 2.5-1.8 3-.5 7.6 1.3 10.1.9 1.2 1.9 2.6 3.2 2.5 1.3 0 1.8-.8 3.3-.8s2 .8 3.3.8c1.4 0 2.3-1.2 3.1-2.5.6-.9 1.1-2 1.1-2.1s-2.6-1-2.6-3.6z', fill: true }],
...
export default function Icon({ name, size = 20, color = 'currentColor', filled = false, strokeWidth = 2.75, style }) {
  const shapes = ICONS[name];
  if (!shapes) return null;
  const fillOnly = shapes.some((s) => s.fill);
