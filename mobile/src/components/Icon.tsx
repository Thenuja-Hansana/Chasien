...
const ICONS: Record<string, Shape[]> = {
  ...
  // the show/hide-password toggle (TextField.tsx).
  eyeOff: [
    { t: 'path', d: 'M2 12s3.6-6.5 10-6.5S22 12 22 12s-3.6 6.5-10 6.5S2 12 2 12z' },
    { t: 'circle', cx: 12, cy: 12, r: 2.6 },
    { t: 'path', d: 'M3 3l18 18' },
  ...
  // Not part of app_reference/src/components/Icon.jsx's set — added for
  // the post overflow menu's Delete action (PostOptionsMenu.tsx).
  trash: [
    { t: 'path', d: 'M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2' },
  ...
  chevronLeft: [{ t: 'path', d: 'm15 6-6 6 6 6' }],
